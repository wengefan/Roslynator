...
namespace Roslynator.VisualStudio
{
    public partial class RefactoringsOptionsPage
    {
        ...
        public void Fill(ICollection<BaseModel> refactorings)
        {
            ...
            refactorings.Add(new BaseModel(RefactoringIdentifiers.MergeStringExpressions, "Merge string expressions", IsEnabled(RefactoringIdentifiers.MergeStringExpressions)));

...
namespace Roslynator.CSharp
{
    internal static class CompilerDiagnosticIdentifiers
    {
        ...
        public const string ModifierIsNotValidForThisItem = Prefix + "0106";
        public const string MoreThanOneProtectionModifier = Prefix + "0107";
        ...
        public const string PointersAndFixedSizeBuffersMayOnlyBeUsedInUnsafeContext = Prefix + "0214";
        ...
        public const string PartialModifierCanOnlyAppearImmediatelyBeforeClassStructInterfaceOrVoid = Prefix + "0267";
        public const string AccessibilityModifiersMayNotBeUsedOnAccessorsInInterface = Prefix + "0275";
        ...
        public const string ClassCannotBeBothStaticAndSealed = Prefix + "0441";
        ...
        public const string AccessModifiersAreNotAllowedOnStaticConstructors = Prefix + "0515";
        ...
        public const string FieldCanNotBeBothVolatileAndReadOnly = Prefix + "0678";
        ...
        public const string OnlyMethodsClassesStructsOrInterfacesMayBePartial = Prefix + "0753";
        ...
        public const string ModifiersCannotBePlacedOnEventAccessorDeclarations = Prefix + "1609";

...
namespace Roslynator.CSharp.Refactorings
{
    ...
    {
        private static ReduceIfNestingOptions ReduceIfNestingOptions { get; } = new ReduceIfNestingOptions(allowNestedFix: true, allowLoop: true, allowSwitchSection: true);
